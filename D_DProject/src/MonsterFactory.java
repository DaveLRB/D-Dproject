class MonsterFactory {
    public static Monster createMonster(MonsterType monsterType) {
        return switch (monsterType) {
            case SLIME -> new Monster("Slime", 15, 100, 15 , 35,true, false, false, false,
            ...
            case BABYSPIDERS -> new Monster("Baby Spider", 20, 100, 15 , 35,true, true, false, false,
            ...
            case GOBLIN -> new Monster("Goblin", 25, 100, 15 , 35,true, false, false,false,
            ...
            case SKELETON -> new Monster("Skeleton", 30, 100, 15 , 35,true, false, false,false,
            ...
            case ZOMBIE -> new Monster("Zombie", 35, 100, 15 , 35,true, true, false,false,
            ...
            case SPECTRE -> new Monster("Spectre", 40, 100, 35 , 55,true, false, false,false,
            ...
            case WEREWOLF -> new Monster("Werewolf", 45, 100, 35 , 55,true, false, false,false,
            ...
            case GHOST -> new Monster("Ghost", 50, 100,35 , 55,true,  false, false,false,
            ...
            case WITCH -> new Monster("Witch", 55, 100, 35 , 55,true, false, false,false,
            ...
            case VAMPIRE -> new Monster("Vampire", 60, 100,35 , 55,true,  true, false,false,
            ...
            case MUMMY -> new Monster("Mummy", 65, 100, 55 , 75,true, false, false,false,
            ...
            case CREEPER -> new Monster("Creeper", 70, 100, 55 , 75,true,  false, false,false,
            ...
            case HARPY -> new Monster("Harpy", 75, 100,55 , 75,true,  false, false,false,
            ...
            case CENTAUR -> new Monster("Centaur", 80, 100, 55 , 75,true, false, false,false,
            ...
            case CYCLOPS -> new Monster("Cyclops", 90, 100, 75 , 95,true, false, false,false,
            ...
            case BASILISK -> new Monster("Basilisk", 95, 100,75 , 95,true,  false, false,false,
            ...
            case GRIFFIN -> new Monster("Griffin", 100, 100, 75 , 95,true, false, false,false,
            ...
            case CHIMERA -> new Monster("Chimera", 105, 100, 75 , 95,true, false, false,false,
            ...
            case MEDUSA -> new Monster("Medusa", 110, 100,75 , 95, true, false, false,false,
            ...
            case WYVERN -> new Monster("Wyvern", 115, 100, 95 , 105,true, false, false,false,
            ...
            case PHOENIX -> new Monster("Phoenix", 120, 100, 95 , 105,true, false, false,false,
            ...
            case KRAKEN -> new Monster("Kraken", 125, 100,95 , 105,true,  false, false,false,
            ...
            case BEHEMOTH -> new Monster("Behemoth", 130, 100, 95 , 105,true, false, false,false,
            ...
            case DRAGON -> new Monster("Dragon", 150, 100,95 , 105,true,  false, false,false,
